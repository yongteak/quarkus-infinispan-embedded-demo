...
./nstart.sh --node-prefix=1 --bind-address="3.38.112.179" --initial_hosts="ec2-3-38-112-179.ap-northeast-2.compute.amazonaws.com[7800],ec2-3-38-112-179.ap-northeast-2.compute.amazonaws.com[7801],ec2-3-38-112-179.ap-northeast-2.compute.amazonaws.com[7803],ec2-3-38-112-179.ap-northeast-2.compute.amazonaws.com[7804]"
